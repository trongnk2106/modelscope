...
def t2v_pipeline_modify(pipe_t2v, text_input, output_path, max_frames = 16):
...
def main(local_dir, text_input, output_path, max_frames = 16, target_fps = 8, num_timestep = 1000):
    ...
    t2v_pipeline = pipeline('text-to-video-synthesis',model=  t2v_model_dir, num_timestep = num_timestep, device='cuda:0')
    v2v_pipeline = pipeline('video-to-video', model = v2v_model_dir, model_revision = 'v1.1.0', 
                            device='cuda:0', num_timestep = num_timestep, target_fps = target_fps, max_frames = max_frames)
    
    t2v_path = t2v_pipeline_modify(t2v_pipeline, text_input, output_path, max_frames = 16)
...
if __name__ == '__main__':
    ...
    text_input = ''
    output_path = ''
    result = main(local_dir, text_input, output_path, max_frames = 16, target_fps=8, num_time_step = 1000)